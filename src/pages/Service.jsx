    ...
    <div className="min-h-screen">
      ...
      <div className="px-6 py-10 flex flex-col items-center services-page">
        ...
        <div className="service-card w-full max-w-2xl p-6">
          <h2 className="text-xl mb-3 list-service">🌐 Simple Front-end Website</h2>
        ...
        <div className="service-card w-full max-w-2xl p-6 mb-8 pb-10">
          <h2 className="mb-3 text-xl list-service">🌐 Full Website (Front-end + Back-end)</h2>
          <p className="mb-4 Service-sub">
        ...
        <div className="service-card w-full max-w-2xl p-6 mb-8">
          <h2 className="mb-3 text-xl list-service">🧩 Add-On Features</h2>
        ...
        {/* Support & Maintenance */}
        <div className="service-card w-full max-w-2xl p-6 mb-8">
          <h2 className="mb-2 text-xl list-service">Support & Maintenance</h2>
        ...
        {/* Maintenance Options */}
        <div className="service-card w-full max-w-2xl p-6 mb-8">
          <h2 className="mb-3 text-xl list-service">📦 Maintenance Options</h2>
        ...
        <div className="service-card w-full max-w-2xl p-6 mb-6">
          <h2 className="mb-3 text-xl list-service">🌐 Hosting & Deployment</h2>
          ...
          <ul className="list-disc ml-6 title-text">
            <li><strong>SiteGround – Best overall</strong></li>
            <li><strong>Hostinger – Best budget</strong></li>
            <li><strong>Krystal – Best UK hosting</strong></li>
            <li><strong>Cloudways – Best flexible hosting</strong></li>
            <li><strong>Kinsta – Best WordPress hosting</strong></li>
          </ul>
        </div>
